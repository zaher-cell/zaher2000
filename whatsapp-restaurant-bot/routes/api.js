...
const { getState, requestPairingCode, cancelPairing } = require("../bot/client");
...
// طلب كود اقتران (Pairing Code) بديل عن مسح QR — لربط الجهاز برقم مباشرة
...
// إلغاء كود الاقتران والرجوع لوضع QR
